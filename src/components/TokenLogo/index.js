...
import bittorrentLogo from "../../assets/images/bittorrent.svg";
import sUSDLogo from "../../assets/images/oikos.svg";
...
export default class TokenLogo extends Component {
  ...
  render() {
    ...
    let path = "";
    const mainAddress = RINKEBY_TOKEN_MAP[address]
      ? RINKEBY_TOKEN_MAP[address]
      : address;
    ...
    if (
      ...
      if (mainAddress == sBTTAddress) path = bittorrentLogo;
      if (mainAddress == sUSDAddress) path = sUSDLogo;
    }
